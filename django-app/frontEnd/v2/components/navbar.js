...
export const NavBar = () => {
    ...
    return (
        <>
            <div className="flex flex-row items-center justify-between px-4 bg-gray-100 dark:bg-neutral-800">
                <h2 className="mt-5 opacity-50 border p-2 rounded-2xl hover:bg-blue-200 cursor-pointer"
                    onClick={() => router.push('/home')}
                >
                    Token
                </h2>
                <NavBarRight user={user} router={router} />
            </div>
        </>
    );
}